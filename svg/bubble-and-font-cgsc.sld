        ...
        <se:Rule>
          <se:Name>Single symbol</se:Name>
            ...
            <se:Graphic>
              <!--Parametric SVG-->
              <se:ExternalGraphic>
                <se:OnlineResource xlink:href="https://raw.githubusercontent.com/Central-Goldfields-Shire-Council/POZI-Public/main/svg/pozi-bubble-dark.svg" xlink:type="simple"/>
